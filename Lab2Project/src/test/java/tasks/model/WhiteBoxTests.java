...
public class WhiteBoxTests {
    ...
    public void testPath_P01_CurrentAfterOrEqualsEnd() {
        ...
        // Assert
        assertNull(nextTime, "Should return null when current equals end");
    }
    ...
    public void testPath_P02_RepeatedActiveBeforeStart() {
        ...
        // Assert
        assertEquals(startTime, nextTime, "Should return start time when current is before start");
    }
    ...
    public void testPath_P03_RepeatedActiveEqualsTimeAfter() {
        ...
        // Assert
        assertEquals(expectedNext, nextTime, "Should return start+interval when current equals start");
    }
    ...
    public void testPath_P04_RepeatedActiveBetweenTimepoints() {
        ...
        // Assert
        assertEquals(expectedNext, nextTime, "Should return timeBefore when current is between timepoints");
    }
    ...
    public void testPath_P05_LoopExitsThenNonRepeatedBeforeTask() {
        ...
        // Assert
        assertEquals(expectedNext, nextTime, "Should return task time for non-repeated task after loop exit");
    }
    ...
    public void testPath_P06_RepeatedActiveOutsideRangeThenNonRepeatedBefore() {
        ...
        // Assert
        assertEquals(expectedNext, nextTime, "Should return task time for non-repeated task when current is before it");
    }
    ...
    public void testPath_P07_RepeatedActiveOutsideRangeThenNonRepeatedInactive() {
        ...
        // Assert
        assertNull(nextTime, "Should return null for inactive non-repeated task");
    }
    ...
    public void testPath_P08_NonRepeatedActiveBeforeTask() {
        ...
        // Assert
        assertEquals(taskTime, nextTime, "Should return task time for non-repeated active task when current is before it");
    }
    ...
    public void testPath_P09_NonRepeatedInactive() {
        ...
        // Assert
        assertNull(nextTime, "Should return null for non-repeated inactive task");
    }
}